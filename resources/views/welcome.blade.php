...
<body>
    <form action="add" class="w-25 " method="get">
        @csrf
        id:
        <input  class='form-control'  type="text" placeholder="nom" name="id"> <br>
        nom:
        <input class='form-control'  type="text" placeholder="nom" name="nom"> <br>
        prenom:
        <input class='form-control'  type="text" placeholder="nom" name="prenom"> <br>
